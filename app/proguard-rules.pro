...
#自己项目特殊处理代码
#忽略警告
-dontwarn com.mseen.domain.**
#保留一个完整的包
-keep class com.mseen.domain.dao.** { #这个是green dao 类
    *;
 }
...
#保持枚举 enumclass 类不被混淆 如果混淆报错，建议直接使用上面的 -keepclassmembers class * implements java.io.Serializable即可
#-keepclassmembers enumclass * {
