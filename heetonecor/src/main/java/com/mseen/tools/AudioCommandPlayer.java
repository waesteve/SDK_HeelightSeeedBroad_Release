...
class AudioCommandPlayer {
    ...
    public native void createLongControlPackageAudioMainFromJNI(String dataStr, String wavFile);
    ...
    static AudioCommandPlayer getAudioCommandPlayer(Context context) {
        if (mAudioCommandPlayer == null) {
            ...
            mAudioCommandPlayer.init(context);
        }
...
//            return;
    ...
    protected void playLongAudioCommandByJNI(File wavFile, String dataStr) {
        createLongControlPackageAudioMainFromJNI(dataStr, wavFile.getAbsolutePath());
    }
